...
{
    /// <inheritdoc />
    public partial class InvoiceSettings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyPhone = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    CompanyAddress = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    LogoPath = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    AccentColor = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    HeaderHtml = table.Column<string>(type: "text", nullable: false),
                    IntroHtml = table.Column<string>(type: "text", nullable: false),
                    FooterHtml = table.Column<string>(type: "text", nullable: false),
                    TermsHtml = table.Column<string>(type: "text", nullable: false),
